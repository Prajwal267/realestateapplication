        ...
        <footer>
            <div className="footer-container">
                <div className="footer-column">
                    ...
                    <p><i className="fas fa-map-marker-alt" style={{ color: 'red', marginRight: '10px' }}></i>  Collins Street West, Victoria 8007, Australia.</p>
                    <p><i className="fas fa-phone" style={{ color: 'red', marginRight: '10px' }}></i>  +123 456 7890</p>
                    <p><i className="fas fa-envelope" style={{ color: 'red', marginRight: '10px' }}></i>  info@example.com</p>
                </div>
                <div className="footer-column">
                    <h2>Navigation</h2>
                    <ul>
