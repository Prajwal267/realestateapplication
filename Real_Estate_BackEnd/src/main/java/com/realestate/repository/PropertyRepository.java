...
public interface PropertyRepository extends JpaRepository<Property, Integer> {
	 ...
	 * 
	 * List<Property>
	 * findByPropertyPriceAndPropertySqFtAndPropertyStatusInAndPropertyCategoryInAndPropertyCityIn
	 * (String propertyPrice, String propertySqFt, List<String> propertyStatus,
