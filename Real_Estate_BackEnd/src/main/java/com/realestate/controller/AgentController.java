...
public class AgentController {
	...
	public ResponseEntity<List<Property>> filterProperties(@RequestHeader("Authorization") String jwt,
		...
		System.out.println("Size is " +filteredProperties.size());
		...
		System.out.println("Specific Filtered Properties: "+getSpecificProperty);
		System.out.println("Size is " +getSpecificProperty.size());
		return new ResponseEntity<>(getSpecificProperty,HttpStatus.OK);
	}
}
